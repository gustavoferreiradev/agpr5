...
if (!class_exists('Redux_Framework_BE_update_config')) {

    class Redux_Framework_BE_update_config {
        ...
        public function setSections() {
            ...
            // General Settings
            $this->sections[] = array(
                'title'     => __('Purchase Code', 'oshin'),
                'desc'      => '',//__('Enter the Themeforest Purchase code here. This will be used to validate and enable the Theme Auto Update feature.', 'oshin'),
                'icon'      => 'el-icon-adjust-alt',
                'fields'    => array(
                    array (
                        'id' => 'theme_purchase_code',
                        'type' => 'text',
                        'title' => __('Enter Code', 'oshin'), 
                        'subtitle' => __('You can find the code here', 'oshin'),
                        'desc' => __('', 'oshin'),
                        'default' => ''
                        ),
                ),
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'be_themes_purchase_data',            // This is where your data is stored in the database and also becomes your global variable name.
                'disable_tracking'  => true,
                'display_name'      => $theme->get('Name').' Purchase Code',     // Name that appears at the top of your panel
                'display_version'   => '',  // Version that appears at the top of your panel
                'menu_type'         => 'submenu',                  //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                'allow_sub_menu'    => true,                    // Show the sections below the admin menu item or not
                'menu_title'        => __('Oshin Purchase Code', 'oshin'),
                'page_title'        => __('Oshin Purchase Code', 'oshin'),
                ...
                'page_slug'         => '_purchase_code',              // Page slug used to denote the panel
    ...
    global $updateConfig;
    $updateConfig = new Redux_Framework_BE_update_config();
}
