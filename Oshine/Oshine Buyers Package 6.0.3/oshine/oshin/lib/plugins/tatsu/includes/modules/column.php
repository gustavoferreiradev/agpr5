...
if (!function_exists('tatsu_column')) {
	function tatsu_column( $atts, $content ) {
		...
		$output .= '<div id="'.$column_id.'" class="tatsu-column '.$column_class.'" data-animation="'.$animation_type.'" data-animation-delay="'.$animation_delay.'" data-parallax-speed="'.$column_parallax.'" style="'.$margin.$border.$custom_gutter.$col_offset.$z_index_style.'">';
